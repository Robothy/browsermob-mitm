...
public class ClasspathResourceUtil {
     ...
     * {@link java.io.UncheckedIOException}. If the classpath resource cannot be found, this
     ...
     * @return a String
     * @throws java.io.UncheckedIOException if the classpath resource cannot be found or cannot be read for any reason
     */
    public static String classpathResourceToString(String resource, Charset charset) throws java.io.UncheckedIOException {
        if (resource == null) {
        ...
        try (InputStream resourceAsStream = ClasspathResourceUtil.class.getResourceAsStream(resource)) {
            if (resourceAsStream == null) {
                throw new java.io.UncheckedIOException(new FileNotFoundException("Unable to locate classpath resource: " + resource));
            }
